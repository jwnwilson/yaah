...
test("lists runs and starts a new one", async () => {
  ...
  server.use(
    ...
    http.post("/api/work-items/t1/runs", () => {
      const run: Run = { id: "r1", owner_id: "u", task_id: "t1", team_id: "tm", status: "pending", stage: null, branch: null, pr_url: null, cost_usd: 0, input_tokens: 0, output_tokens: 0, cache_read_tokens: 0, cache_creation_tokens: 0, created_at: "x" };
      runs.push(run);
